"""
This is an extension of model_1 that includes H2O2 inhibition of PTEN
"""
...
# 4. pten inhibition
Parameter('kf_3', 0.1)
Rule('pten_inhibition', h2o2(b=None) + pten(b=None) >> h2o2(b=None), kf_3)

# 5. h2o2 degradation
Parameter('kf_4', 0.1)
Rule('h2o2_degradation', h2o2(b=None) >> h2o2_sink(b=None), kf_4)
